...
def action():
    ...
    ao3.download(link, filetypes, strings.READING_LIST_FOLDER_NAME, logfile, session, subfolders, pages, series, images) # mkp - use reading list downloads folder instead of general downloads folder
