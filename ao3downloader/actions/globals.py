...
# START mkp - add reading log definition
def get_readinglogfile() -> str:
	if not os.path.exists(strings.LOG_FOLDER_NAME):
		os.mkdir(strings.LOG_FOLDER_NAME)
	return os.path.join(strings.LOG_FOLDER_NAME, strings.READINGLOG_FILE_NAME)
# END mkp - add reading log definition 
