...
def action():
    ...
    link = strings.SUBSCRIPTIONS_URL_NAME # mkp - automatically use subscriptions url
    if latest:
    ...
    fileio.make_dir(strings.DOWNLOAD_FOLDER_NAME) # mkp - by default, use the general downloads folder
    
    ao3.download(link, filetypes, strings.DOWNLOAD_FOLDER_NAME, logfile, session, subfolders, pages, series, images) # mkp - by default, use the general downloads folder
